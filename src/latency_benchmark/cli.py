...
@click.option("--endpoint", default="wss://streaming.assemblyai.com", help="AssemblyAI streaming WebSocket endpoint")
...
@click.option("--speech-model", default=None, help="Speech model override")
